    ...
    <>
      ...
      {theme !== null && (
        <button
          ...
          className="fixed bottom-24 right-6 z-[90] md:bottom-8 md:right-8 md:left-auto bg-white text-[#1A1A1A] border border-[#1A1A1A]/10 rounded-full p-2.5 transition-all duration-300 shadow-lg dark:bg-[#1a1a1a] dark:text-white dark:border-white/15 flex items-center justify-center hover:scale-110 active:scale-95"
        >
          {theme === "light" ? (
            <svg
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M12 3v2m0 14v2m9-9h-2M5 12H3m15.36-6.36-1.41 1.41M7.05 16.95l-1.41 1.41M18.36 18.36l-1.41-1.41M7.05 7.05L5.64 5.64M12 7a5 5 0 100 10 5 5 0 000-10z"
              />
            </svg>
          )}
        </button>
